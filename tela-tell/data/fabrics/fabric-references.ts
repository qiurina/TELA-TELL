...
const FABRIC_REFERENCE_IMAGES: Record<SupportedFabric, ImageSourcePropType> = {
  ...
  Jusi: require('@/assets/images/reference/jusi.png'),
};
...
export const FABRIC_REFERENCES: Record<SupportedFabric, FabricReference> = {
  ...
  Silk: {
    ...
    textureNote: 'Fine drape and clean reflection — formal blouses and lining fabrics',
  ...
  Linen: {
    ...
    textureNote: 'Airy summer hand-feel — wrinkles easily in humid weather',
  ...
  Acrylic: {
    ...
    textureNote: 'Budget sweaters — pills faster than natural wool',
  ...
  Rayon: {
    ...
    textureNote: 'Dresses and blouses — can look silk-like at lower cost',
  ...
  Jusi: {
    fabric: 'Jusi',
    title: 'Jusi',
    lookFor: 'Smooth piña-silk blend look with more body than sheer organza',
    textureNote: 'Common in pre-owned barong — slightly heavier than pure piña',
    image: FABRIC_REFERENCE_IMAGES.Jusi,
  },
};
